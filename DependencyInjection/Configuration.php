                ...
                ->arrayNode('admin')
                    ->children()
                        ->arrayNode('post')
                            ->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('class')->defaultValue('Sonata\\NewsBundle\\Admin\\PostAdmin')->end()
                                ->scalarNode('controller')->defaultValue('SonataAdminBundle:CRUD')->end()
                                ->scalarNode('translation')->defaultValue('SonataNewsBundle')->end()
                            ->end()
                        ->end()
                        ->arrayNode('category')
                            ->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('class')->defaultValue('Sonata\\NewsBundle\\Admin\\CategoryAdmin')->end()
                                ->scalarNode('controller')->defaultValue('SonataAdminBundle:CRUD')->end()
                                ->scalarNode('translation')->defaultValue('SonataNewsBundle')->end()
                            ->end()
                        ->end()
                        ->arrayNode('comment')
                            ->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('class')->defaultValue('Sonata\\NewsBundle\\Admin\\CommentAdmin')->end()
                                ->scalarNode('controller')->defaultValue('SonataAdminBundle:CRUD')->end()
                                ->scalarNode('translation')->defaultValue('SonataNewsBundle')->end()
                            ->end()
                        ->end()
                        ->arrayNode('tag')
                            ->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('class')->defaultValue('Sonata\\NewsBundle\\Admin\\TagAdmin')->end()
                                ->scalarNode('controller')->defaultValue('SonataAdminBundle:CRUD')->end()
                                ->scalarNode('translation')->defaultValue('SonataNewsBundle')->end()
                            ->end()
                        ->end()
